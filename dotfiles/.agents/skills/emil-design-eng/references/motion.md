...
| Frequency                                                   | Decision                     |
| ----------------------------------------------------------- | ---------------------------- |
| 100+ times/day (keyboard shortcuts, command palette toggle) | Prefer instant feedback; keep only useful, unobtrusive motion          |
| Tens of times/day (hover effects, list navigation)          | Remove or drastically reduce |
| Occasional (modals, drawers, toasts)                        | Standard animation           |
| Rare/first-time (onboarding, feedback forms, celebrations)  | Can add delight              |

**Frequent actions need immediate feedback.** Judge frequency and delay rather than banning animation by input method.
...
**Ease-out is a useful default for entrances and direct feedback.** A slow start can feel delayed; use acceleration when it serves the intended motion and preserves responsiveness.
